...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAllProductsAllProductsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPrintOnePrintOneComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPrintPrintComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUpdateProductUpdateProductComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAddProductAddProductComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AddProductComponent(_http, _formBuilder) {
      ...
      _createClass(AddProductComponent, [{
        ...
        value: function addProduct() {
          ...
          this._http.post('http://localhost/api/product/add', this.dataForm.value).subscribe(function (res) {
            if (res.success) {
              console.log('res', res);
  ...
  /***/
  function srcAppAllProductsAllProductsComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAllProductsAllProductsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function AllProductsComponent(_http, _router) {
      ...
      _createClass(AllProductsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this._http.get('http://localhost/api/product').subscribe(function (res) {
            if (res.success) {
              console.log('res', res);
              _this2.data = res.message;
              console.log('res', _this2.data);
            } else {
              console.log('res', res); // this.message = 'false';
              // document.getElementById("myModal").style.display = "block";
            }
          });
        }
        ...
        value: function remove(id) {
          ...
          this._http.delete("http://localhost/api/product/remove/".concat(id)).subscribe(function (res) {
            if (res.success) {
              console.log('res', res);
              ...
              document.getElementById("myModal").style.display = "block"; // console.log('res', this.data);
            } else {
              console.log('res', res);
    ...
    AllProductsComponent.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }, {
    ...
    AllProductsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-all-products',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./all-products.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/all-products/all-products.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./all-products.component.css */
      "./src/app/all-products/all-products.component.css")).default]
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _bills_bills_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _print_one_print_one_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./print-one/print-one.component */
    "./src/app/print-one/print-one.component.ts");
    /* harmony import */


    var _all_products_all_products_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./all-products/all-products.component */
    "./src/app/all-products/all-products.component.ts");
    /* harmony import */


    var _update_product_update_product_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    var routes = [{
      ...
      path: 'bills',
      component: _bills_bills_component__WEBPACK_IMPORTED_MODULE_5__["BillsComponent"]
    }, {
      path: 'print',
      component: _print_print_component__WEBPACK_IMPORTED_MODULE_6__["PrintComponent"]
    }, {
      path: 'allProducts',
      component: _all_products_all_products_component__WEBPACK_IMPORTED_MODULE_8__["AllProductsComponent"]
    }, {
      path: 'print/:id',
      component: _print_one_print_one_component__WEBPACK_IMPORTED_MODULE_7__["PrintOneComponent"]
    }, {
      path: 'updateProduct/:id',
      component: _update_product_update_product_component__WEBPACK_IMPORTED_MODULE_9__["UpdateProductComponent"]
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _bills_bills_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./bills/bills.component */
    "./src/app/bills/bills.component.ts");
    /* harmony import */


    var _print_print_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./print/print.component */
    "./src/app/print/print.component.ts");
    /* harmony import */


    var ngx_print__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ngx-print */
    "./node_modules/ngx-print/fesm2015/ngx-print.js");
    /* harmony import */


    var _print_one_print_one_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./print-one/print-one.component */
    "./src/app/print-one/print-one.component.ts");
    /* harmony import */


    var _all_products_all_products_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./all-products/all-products.component */
    "./src/app/all-products/all-products.component.ts");
    /* harmony import */


    var _update_product_update_product_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./update-product/update-product.component */
    "./src/app/update-product/update-product.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _add_product_add_product_component__WEBPACK_IMPORTED_MODULE_6__["AddProductComponent"], _bills_bills_component__WEBPACK_IMPORTED_MODULE_8__["BillsComponent"], _print_print_component__WEBPACK_IMPORTED_MODULE_9__["PrintComponent"], _print_one_print_one_component__WEBPACK_IMPORTED_MODULE_11__["PrintOneComponent"], _all_products_all_products_component__WEBPACK_IMPORTED_MODULE_12__["AllProductsComponent"], _update_product_update_product_component__WEBPACK_IMPORTED_MODULE_13__["UpdateProductComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], ngx_print__WEBPACK_IMPORTED_MODULE_10__["NgxPrintModule"]],
      providers: [],
  ...
  function srcAppBillsBillsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function BillsComponent(_http, _formBuilder) {
      ...
      _createClass(BillsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this._http.get('http://localhost/api/product').subscribe(function (res) {
            if (res.success) {
              ...
              console.log('res', _this4.data); //   this.message = res.message;
              //  document.getElementById("myModal").style.display = "block";
            } else {
              console.log('res', res); // this.message = 'false';
              // document.getElementById("myModal").style.display = "block";
          ...
          console.log('done'); // dynamicForm(selectedTarget, plusSelector, minusSelector, options)
        }
      }, {
        key: "test",
        ...
        value: function _delete(i) {
          ...
          this.form.value.productInvoice = this.form.value.productInvoice.filter(function (item, index) {
            //  console.log('this.details', index, 'kkk', item.id)
            if (i == index) {
              console.log('this.details: ', i, 'index: ', index);
              var control = _this5.form.controls['productInvoice'];
              control.removeAt(i); //return this.form.value.productInvoice.splice(index, 1)
            }
          });
        }
      }, {
        key: "addCreds",
        value: function addCreds() {
          var creds = this.form.controls.productInvoice;
        ...
        value: function save() {
          ...
          this._http.post('http://localhost/api/invoice/add', this.form.value).subscribe(function (response) {
            if (response.success) {
              _this6.form.value.productInvoice = [];
    ...
    BillsComponent.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }, {
        type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"]
  ...
  /***/
  function srcAppPrintOnePrintOneComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPrintOnePrintOneComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PrintOneComponent", function () {
      return PrintOneComponent;
    });
    /* harmony import */
    ...
    var PrintOneComponent =
    /*#__PURE__*/
    function () {
      function PrintOneComponent(_http, route) {
        _classCallCheck(this, PrintOneComponent);

        this._http = _http;
        this.route = route;
      }

      _createClass(PrintOneComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this7 = this;
          ...
          this.route.paramMap.subscribe(function (params) {
            ...
            _this7._http.get("http://localhost/api/invoice/details/".concat(id)).subscribe(function (res) {
              if (res.success) {
                console.log('res', res);
                _this7.data = res.message;
                console.log('res', _this7.data.Invoices);
              } else {
                console.log('res', res); // this.message = 'false';
                // document.getElementById("myModal").style.display = "block";
              }
    ...
    PrintOneComponent.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }, {
    ...
    PrintOneComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-print-one',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./print-one.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/print-one/print-one.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./print-one.component.css */
      "./src/app/print-one/print-one.component.css")).default]
    })], PrintOneComponent);
    /***/
  },
  ...
  /***/
  function srcAppPrintPrintComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPrintPrintComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function PrintComponent(_http, _router) {
      ...
      _createClass(PrintComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this._http.get('http://localhost/api/invoice').subscribe(function (res) {
            if (res.success) {
              console.log('res', res);
              _this8.data = res.message;
              console.log('res', _this8.data);
            } else {
              console.log('res', res); // this.message = 'false';
              // document.getElementById("myModal").style.display = "block";
            }
    ...
    PrintComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/print/print.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./print.component.css */
      "./src/app/print/print.component.css")).default]
    })], PrintComponent);
    /***/
  },
  ...
  /***/
  function srcAppUpdateProductUpdateProductComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUpdateProductUpdateProductComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function UpdateProductComponent(_http, route, _formBuilder) {
      ...
      _createClass(UpdateProductComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.paramMap.subscribe(function (params) {
            ...
            _this9._http.get("http://localhost/api/product/details/".concat(id)).subscribe(function (res) {
              if (res.success) {
                console.log('res', res);
                _this9.data = res.message; // console.log('res', this.data.Invoices);
              } else {
                console.log('res', res); // this.message = 'false';
                // document.getElementById("myModal").style.display = "block";
              }
        ...
        value: function update(id) {
          ...
          var final = this.clean(object);

          this._http.put("http://localhost/api/product/edit/".concat(id), final).subscribe(function (res) {
            if (res.success) {
              console.log('res', res);
    ...
    UpdateProductComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./update-product.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/update-product/update-product.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./update-product.component.css */
      "./src/app/update-product/update-product.component.css")).default]
    })], UpdateProductComponent);
    /***/
  },
